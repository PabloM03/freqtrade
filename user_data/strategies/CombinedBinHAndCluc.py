...
NO_BUY_BB_MULT = 1.005          # � Multiplicador de la banda media BB para evitar compras "arriba". Rango típico: 1.01-1.15. Subirlo permite comprar más alto.
NO_BUY_EMA20_MULT = 1.004       # � Multiplicador de EMA20 para evitar compras "arriba". Rango típico: 1.0-1.05. Subirlo permite comprar más alto.
...
A_RSI_PREV_MAX = 52             # � RSI máximo previo para permitir compra en giro alcista tras sobreventa. Rango típico: 40-50. Subirlo permite compras con menos sobreventa previa.
...
# E) Pullback a EMA8
E_RSI_MIN = 42                  # � RSI mínimo para permitir pullback alcista. Rango típico: 40-50. Subirlo exige más fuerza en el rebote.
...
F_BB_PERCENT_MAX = 0.34         # �️ BB% máximo para doble toque en valle. Rango típico: 0.25-0.35. Subirlo permite doble toque en zonas menos bajas.
...
MAX_PCT_UP_1 = 1.0              # % máx. subida en 1 vela para permitir compra (usa misma escala que PCT1_MIN: en %)
MAX_PCT_UP_3 = 2.8              # % máx. subida en 3 velas para permitir compra
MAX_GREEN_STREAK = 3            # nº máx. de velas verdes recientes; si hay racha >= N, no comprar
BUY_BELOW_EMA20_MULT = 1.002    # exigir que el precio esté por DEBAJO de EMA20 (0.998 = -0.2%)
