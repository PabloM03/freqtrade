...
# ==========================
# ✅ PARÁMETROS GLOBALES AJUSTABLES (v3 - OPTIMIZADO PARA SOLANA)
# ==========================

# --- Costes y ganancias mínimas ---
FEE_RATE = 0.001
SLIPPAGE_BUFFER = 0.0005
MIN_PROFIT_NET = 5 * FEE_RATE + SLIPPAGE_BUFFER
...
TIMEFRAME = '15m'  # Ajustado para Solana
STARTUP_CANDLES = 160
...
class SolStrategy(IStrategy):
    ...
    # ---------------------- INDICADORES ----------------------
    def populate_indicators(self, dataframe: DataFrame, metadict) -> DataFrame:
        # BinHV45 (BB40)
        ...
        # EMAs / fuerza
        dataframe['ema8']     = ta.EMA(dataframe, timeperiod=10)  # Ajustado para Solana
        ...
        # RSI / ADX / DI
        dataframe['rsi']      = ta.RSI(dataframe, timeperiod=10)  # Ajustado para Solana
    ...
    # ---------------------- COMPRAS ----------------------
    def populate_buy_trend(self, dataframe: DataFrame, metadict) -> DataFrame:
        anti_cuchillo = (
    ...
    # ---------------------- VENTAS ----------------------
    def populate_sell_trend(self, dataframe: DataFrame, metadict) -> DataFrame:
        # Rechazo fuerte cerca de banda superior
        reject_upper = (
